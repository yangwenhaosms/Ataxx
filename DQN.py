...
##
class BrainDQN:
    def __init__(self,actions,color):
        # init replay memory
        self.color=color
    ...
    def createQNetwork(self):
        # network weights
        W_conv1 = self.weight_variable([4,4,4,64])
        ...
        stateInput = tf.placeholder("float",[None,7,7,4])
        ...
        h_conv2_flat = tf.reshape(h_pool2,[-1,128])
    ...
    def trainQNetwork(self):
        ...
        if self.timeStep % 10000 == 0:
            self.saver.save(self.session, 'C:/Users/peter/Desktop/Ataxx/saved_networks/' + 'network' + '-dqn', global_step = self.timeStep)
